	<!DOCTYPE html>
		...
		<body>
		  ...
		  <div class="row">
		  <form method="POST" action="borrow_confirmation.php">
		  <div class="card blue-grey darken-1 col s6 offset-s3">
			<div class="card-content white-text">
				<span class="card-title center-align">Issue Book</span>
					<div class="row">
					<div class='input-field'>
						<input placeholder="Reader ID" name="reader_id" type="text" class="validate" length="5">
					</div>
					...
					<div class='input-field '>
						<input placeholder="Copy Number" name="copy_num" type="number" class="validate" length="2">
					</div>
					
					<button class="btn waves-effect waves-light red lighten-2 col s2" name="add" type="submit" value="submit">Issue<i class="material-icons right">trending_flatflat</i>
					</button>
				</div>
			</div>
		</div>	
