...
<body>
	...
	<div class="row">
		<form class="col s8 offset-s2" method="post" action="add_book_q.php">
		<div class="card blue-grey darken-1">
		<div class="card-content white-text">
		<span class="card-title">Book Details</span>
			<div class="row">
				<div class="input-field col s6">
					<input placeholder="Book ISBN" name="book_isbn" type="text" class="validate" length="9">
				</div>
				<div class="input-field col s6">
		...
		<div class="card blue-grey darken-1">
		<div class="card-content white-text">
		<span class="card-title">Author Detail</span>
			<div class="row">
				<div class="input-field col s6">
					<input placeholder="Author Name" name="author_name" type="text" class="validate" length="30">
				</div>
				<div class="input-field col s6">
					<input placeholder="Author_id" name="author_id" type="text" class="validate" length="5">
				</div>
			</div>
		</div>
		</div>
		...
		<span class="card-title">Document Details</span>
			<div class="row">
				...
				<div class='input-field col s6'>
					<input placeholder="Descriptors (keep only a space between them)" name="descriptor" type="text" class="validate" length="50">
				</div>
...
― Jane Austen, Pride and Prejudice</p>
  ...
  $('.chips').material_chip({placeholder: 'Enter a tag',
    secondaryPlaceholder: '+Descriptors',});
