...
<body>
	...
	<div class="row">
		<form class="col s8 offset-s2" method="post" action="add_conference_q.php">
		<div class="card blue-grey darken-1">
		<div class="card-content white-text">
		<span class="card-title">Conference Proceeding Details</span>
			<div class="row">
				<div class="input-field col s6">
					<input placeholder="Speaker Name" name="cspeaker" type="text" class="validate" length="30">
				</div>
				<div class="input-field col s6">
					<input placeholder="Conference Location" name="clocation" type="text" class="validate" length="20">
				</div>
				<div class='input-field col s6'>
					<input placeholder="Conference Date" name="cdate" type="date" class="datepicker" >
				</div>
				<div class='input-field col s6'>
		...
		<span class="card-title">Document Details</span>
			<div class="row">
				...
				<div class="input-field col s4">
					<input placeholder="Number of Copies" name="num_copies" type="number" class="validate" length="2" disabled>
				</div>
				<div class='input-field col s6'>
					<input placeholder="Publisher ID Not Required" name="publisher_id" type="text" class="validate" disabled>
				</div>
				<div class='input-field col s6'>
